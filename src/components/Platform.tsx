    ...
    <section className={styles.platform} id="platform">
      <div className="wrap">
        <div className={styles.header}>
          <div>
            <span className={styles.sectionNum}>03 — Platform</span>
        ...
        <div className={styles.cards}>
          <article className={styles.card}>
            ...
            <a href="#quality">Quality framework →</a>
          </article>
          <article className={styles.card}>
            ...
            <a href="#quality">Regulatory framework →</a>
          </article>
          <article className={styles.card}>
            ...
            <a href="#partners">Supply integrity →</a>
          </article>
          <article className={styles.card}>
            ...
            <a href="#medical-education">Medical &amp; Scientific Education →</a>
          </article>
        </div>
